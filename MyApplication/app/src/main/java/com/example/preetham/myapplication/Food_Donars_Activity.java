...
public class Food_Donars_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food__donars_);
        ...
        ref.child("Donate_food").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot uniqueKeySnapshot : dataSnapshot.getChildren()) {
                    ...
                    String name = uniqueKeySnapshot.child("title").getValue().toString();
                    String phno = uniqueKeySnapshot.child("address").getValue().toString();
