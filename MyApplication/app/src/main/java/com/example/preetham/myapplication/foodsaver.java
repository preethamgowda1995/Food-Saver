...
public class foodsaver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_foodsaver);
        ...
        ref.child("foodsaver").addValueEventListener(new ValueEventListener() {
            @Override
