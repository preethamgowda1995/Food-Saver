...
public class zerowaste extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref.child("zero_waste").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot uniqueKeySnapshot : dataSnapshot.getChildren()) {
                    ...
                    String name = uniqueKeySnapshot.child("event_name").getValue().toString();
